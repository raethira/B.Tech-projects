...
public class Sudoku 
{
    ...
    public static void findHiddentriplets(int number, int RCB)
    {
        sudoku curr=null;
        pair[] element=new pair[9];
        int flag=0,i,j,k=0,l,m,num1=0, num2=0,num3=0,boxRow=0,boxColumn=0,box=0;
        ...
        if(k>=3)
        {
            ...
            for(j=0;j<9;j++)
                for(l=0;l<9;l++)
                    for(i=0;i<9;i++)
                    {
                        if(element[j].position[i]==element[l].position[i] && element[j].position[i]==element[m].position[i]
                                && element[l].position[i]==1 && element[m].count==3
                                && element[l].count==3 && element[j].count==3)
                        {
                            flag=1;		
                            num1=j;
                            num2=l;
                            ...
                            for(i=0;i<9;i++)
                            {
                                ...
                                {	
                                    ...
                                    if(curr.link!=null)
                                        while(curr!=null)
                                        {
                                            if(curr.data!=num1 && curr.data!=num2 && curr.data!=num3 && curr.data!=0)
                                                curr.link=curr.link;
                                            curr=curr.link;
                                        }
                                }
    ...
    public static void read() throws IOException
    {
        ...
        File fp=new File("E:\\sudoku\\Ques\\q1.txt");

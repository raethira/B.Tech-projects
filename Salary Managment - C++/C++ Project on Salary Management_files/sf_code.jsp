...
;
        ...
        superfish.b.ip="101.63.253.100";
        superfish.b.userid="fastest00_fastestchrome_900_";
        superfish.b.appVersion="12.0.9.2";
...
;
    ...
    stDt: [{},
        ...
        {   // 4 - spanish
            ...
            lngNum: 30,
            stRx: /políticas de envío|envío (gratuito|gratis)|envíos y gastos envío|comprar ya en 1-clic|(tu|mi|ir|la|a) cesta|ver carrito|lista de (favoritos|deseos)|mi cuenta|cheques regalo|añadir a cesta|devolución y envío gratuitos/gi,
            stNum: 0   
        },
        {   // 5 - italian
            lng: 'it',
    ...
    isProductInPage: function(pipProps){
           ...
           if (pipLinksExists && this.$('a:regex(href,'+ pipLinksExists + ')').length > 0){
            ...
            if (this.matchedBrand) {
                this.matchedBrand = this.arrUn(this.matchedBrand).join(" | ").replace(" | undefined","");
